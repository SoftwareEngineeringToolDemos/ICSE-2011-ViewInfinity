...
#ifndef FILEMINIMAPNODEGRAPHIC_H
#define FILEMINIMAPNODEGRAPHIC_H
...
class FileMiniMapNodeGraphic : public QGraphicsItem
{
public:
	FileMiniMapNodeGraphic(SMVMain *graphWidget);
	...
	std::vector<qreal>							fragYStart;
	std::vector<qreal>							fragYEnd;
